package net.dragon.engine.player.uuid;
...
public class UUIDFetcher {
     ...
     * @see net.core.uuid.UUIDFetcher#getUUIDAt(String, long)
     */
    public static final long FEBRUARY_2015 = 1422748800000L;


    private static Gson gson = new GsonBuilder().registerTypeAdapter(UUID.class, new com.mojang.util.UUIDTypeAdapter()).create();
     ...
     * @param name The name
     * @param timestamp Time when the player had this name in milliseconds
     * @see net.core.uuid.UUIDFetcher#FEBRUARY_2015
     */
